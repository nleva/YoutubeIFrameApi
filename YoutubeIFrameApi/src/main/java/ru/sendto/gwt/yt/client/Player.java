...
public class Player extends JavaScriptObject {
	...
	static public class VideoParams extends JavaScriptObject {
		...
		final public native String getMediaContentUrl()/*-{
		...
		final public native double getStart()/*-{
		...
		final public native double getEnd()/*-{
		...
		final public native String getQuality()/*-{
			return this.suggestedQuality;
		}-*/;
	...
	static public class VideoListParams extends JavaScriptObject {
		...
		final public native String getListType()/*-{
		...
		final public native String getList()/*-{
			return this.list;
		}-*/;
		...
		final public native Number getIndex()/*-{
			return this.index;
		}-*/;
		...
		final public native Number getStartSeconds()/*-{
			return this.startSeconds;
		}-*/;
		...
		final public native String getSuggestedQuality()/*-{
			return this.suggestedQuality;
		}-*/;
	}
